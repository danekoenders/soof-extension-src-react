  ...
  if (!wasRegenerated) {
    return (
      <div className="relative inline-block animate-fade-in">
        ...
        {showTooltip && (
          <div className="absolute bottom-full left-0 mb-2 w-56 px-2.5 py-2 text-[11px] text-gray-700 bg-white rounded-lg shadow-lg border border-gray-200 z-10">
            <p className="font-medium mb-0.5 text-xs">Claims validatie</p>
            <p className="text-gray-600 leading-tight">
              Dit bericht is gecontroleerd op gezondheidsclaims en voldoet aan de richtlijnen.
            </p>
            <div className="absolute top-full left-3 -mt-1">
              <div className="border-[5px] border-transparent border-t-white" style={{ filter: 'drop-shadow(0 1px 1px rgba(0,0,0,0.1))' }}></div>
            </div>
          </div>
        )}
      </div>
  ...
  return (
    <div className="inline-block w-full animate-fade-in">
      <button
        ...
        className="inline-flex items-center gap-1 px-2 py-0.5 text-[10px] text-green-600/80 bg-green-50/40 rounded hover:bg-green-50/60 transition-colors"
      >
        <svg
          className="w-2.5 h-2.5"
          fill="none"
      ...
      {isExpanded && (
        <div className="mt-2 p-2.5 bg-gray-50/50 rounded border border-gray-200/50">
          <p className="text-[11px] text-gray-600 mb-2 leading-tight">
            Dit bericht is aangepast om te voldoen aan de richtlijnen voor gezondheidsclaims.
          </p>
          ...
          {violatedClaims.length > 0 && (
            <div className="mb-2">
              <h4 className="text-[10px] font-semibold text-red-600 mb-1 flex items-center gap-1">
                ...
                Niet toegestaan ({violatedClaims.length})
              </h4>
          ...
          {allowedClaims.length > 0 && (
            <div>
              <h4 className="text-[10px] font-semibold text-green-600 mb-1 flex items-center gap-1">
                <svg className="w-2.5 h-2.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                Toegestaan ({allowedClaims.length})
              </h4>
              <div className="space-y-1">
