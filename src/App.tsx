                              ...
                              try {
                                ...
                                if (guardrailsBlock && out.length > 0) {
                                  ...
                                  textMessage._guardrailData = {
                                    guardrailEnabled: guardrailsBlock.guardrailEnabled ?? true, // Default true for backward compat
                                    guardrailName: guardrailsBlock.name,
                                    ...
                                    claims: guardrailsBlock.claims
                                      ...
                                      : undefined,
                                    violations: guardrailsBlock.violations,
